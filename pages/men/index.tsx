...
const Index:NextPage = ()=>{
   ...
   const handleDeleteCollection = ()=> setShowCollection(false)
   return(
      ...
      <div className="flex justify-between mb-[3.5rem]">
         ...
         <Men/>
         <div className="absolute left-[0] top-[0] bottom-[0] right-[0] w-full min-h-[100vh] bg-[rgba(0,0,0,0.4)] ">
            <div className="bg-white w-full max-w-[325px] min-h-[100vh] px-[1.3rem] py-[.5rem] " onClick={handleDeleteCollection}>
